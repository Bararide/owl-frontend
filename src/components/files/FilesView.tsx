...
const SemanticGraphCanvas: React.FC<SemanticGraphCanvasProps> = React.memo(({
  files,
  graphData,
  semanticResults,
  isSemanticSearch,
  ...
  // for (const key of prev.fileGroupsMap.keys()) {
  //   if (JSON.stringify(prev.fileGroupsMap.get(key)) !== JSON.stringify(next.fileGroupsMap?.get(key))) return false;
  // }
  return true;
});
